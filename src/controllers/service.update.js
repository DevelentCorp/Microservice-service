            ...
            (err) => {
                ...
                if (!err) {
                    ...
                    if (payload && payload.user.useraccesslevel === '') {
                        Service.findByIdAndUpdate(req.params.serviceId, /*{businessname,
         mobilenumber, adhaarnumber, email, 
         city, pincode: req.body.pincode, state,
         address, contactperson, useraccesslevel}, */{
